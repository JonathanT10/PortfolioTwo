                ...
                <div className="container">
                    <div className="row">
                        <div className="col-sm">
                            <div className="card">
                                <img className="projectpic" src = {TFM} height="250" width="400" alt="Screenshot from my The Founding Marketplace project."></img>
